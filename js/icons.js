/* =============================================================================
   icons.js — Lightweight inline SVG icon set (stroke style, inherits currentColor)
   Exposed as window.Icons. Use Icons.get('name') to retrieve an SVG string,
   or Icons.el('name') for a DOM node.
   ========================================================================== */
(function () {
  "use strict";
  ...
  const P = {
    ...
    fitWidth:    '<path d="M3 8V5a2 2 0 0 1 2-2h3M21 8V5a2 2 0 0 0-2-2h-3M3 16v3a2 2 0 0 0 2 2h3M21 16v3a2 2 0 0 1-2 2h-3"/><line x1="7" y1="12" x2="17" y2="12"/><polyline points="9.5 9.5 7 12 9.5 14.5"/><polyline points="14.5 9.5 17 12 14.5 14.5"/>',
    fitPage:     '<rect x="5" y="3" width="14" height="18" rx="2"/><polyline points="9 8 9 5 12 5"/><polyline points="15 16 15 19 12 19"/>',
    rotateCw:    '<polyline points="21 2 21 8 15 8"/><path d="M21 8a9 9 0 1 0 2.83 5"/>',
    rotateCcw:   '<polyline points="3 2 3 8 9 8"/><path d="M3 8a9 9 0 1 1-2.83 5"/>',
    ...
    strike:      '<path d="M16 4H9a3 3 0 0 0-2.83 4"/><path d="M14 12a4 4 0 0 1 0 8H8"/><line x1="4" y1="12" x2="20" y2="12"/>',
    note:        '<path d="M16 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11l5-5V5a2 2 0 0 0-2-2z"/><path d="M16 21v-5a1 1 0 0 1 1-1h5"/>',
    ...
    eraser:      '<path d="m7 21-4.3-4.3a1 1 0 0 1 0-1.4l9.6-9.6a2 2 0 0 1 2.8 0l5.2 5.2a2 2 0 0 1 0 2.8L13 21"/><path d="M22 21H7"/><path d="m5 12 5 5"/>',
    // sidebar / actions
    search:      '<circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/>',
    save:        '<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/>',
    sun:         '<circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/>',
    moon:        '<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/>',
    menu:        '<circle cx="12" cy="12" r="1.6"/><circle cx="12" cy="5" r="1.6"/><circle cx="12" cy="19" r="1.6"/>',
    ...
    importIcon:  '<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 9 12 4 17 9"/><line x1="12" y1="4" x2="12" y2="16"/>',
    ...
    // phase 2 additions
    quote:       '<path d="M3 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1z"/><path d="M15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2h.75c0 2.25.25 4-2.75 4v3c0 1 0 1 1 1z"/>',
  ...
  function el(name, attrs) {
    ...
    span.innerHTML = get(name, attrs);
    return span.firstChild;
  }

  window.Icons = { get, el, has: (n) => !!P[n] };
})();
